...
public class AddressBookArray {
    ...
    public class AddressBookArrayElement extends AdressBook_Oops {
        Scanner sc=new Scanner(System.in);
        private ArrayList<AdressBook_Oops> contactList = new ArrayList<AdressBook_Oops>();
        ...
        public void editContact(String nameToEdit){
            for(AdressBook_Oops editContact: contactList) {
        ...
        public void printContactDetails(){
            for(AdressBook_Oops getInfo: contactList) {
